...
function recipes_blog_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section(
		new Recipes_Blog_Upsell_Section(
			...
			array(
				...
				'url'              => 'https://www.asterthemes.com/products/recipes-bloggers-wordpress-theme',
	...
	$wp_customize->add_section(
		new Recipes_Blog_Upsell_Section(
			...
			'doc_section',
			array(
				'title'            => __( 'Documentation', 'recipes-blog' ),
				'button_text'      => __( 'Free Doc', 'recipes-blog' ),
				'url'              => 'https://demo.asterthemes.com/docs/recipes-blog-free',
				'background_color' => '#ff7a00',
				'text_color'       => '#fff',
				'priority'         => 1,
			)
